          ...
          >
            {msg.image ? (
              <img
                src={msg.image}
                alt=""
                className="max-w-[230px] border border-gray700 rounded-lg overflow-hiddenmb-8"
              />
            ) : (
              <p
                className={`p-2 max-w-[230px] md:text-sm font-light rounded-b-lg mb-8 break-all bg-violet-500/30 text-white ${
